...
export default function PredictPage() {
  ...
  const handlePrediction = async (input: PredictionInput) => {
    ...
    try {
      console.log(' Making prediction request to:', `${BACKEND_URL}/api/predict`)
      ...
      if (error.message.includes('fetch')) {
        setError('Cannot connect to prediction service. Please check if the backend is running.')
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get personalized salary predictions for AI roles based on your experience, 
            location, and job preferences. Our model achieves 73% accuracy.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            {error && (
              <div className="text-center py-12">
                ...
                <p className="text-red-600 font-medium mb-2">Prediction Error</p>
                ...
                <div className="mt-4 p-4 bg-red-50 rounded-lg text-left">
                  ...
                  <ol className="text-red-700 text-xs mt-2 space-y-1 list-decimal list-inside">
                    <li>Check if Flask backend is running: <code className="bg-red-100 px-1 rounded">python app.py</code></li>
                    <li>Verify backend URL: <code className="bg-red-100 px-1 rounded">{BACKEND_URL}</code></li>
                    <li>Test backend directly: <a href={`${BACKEND_URL}/health`} target="_blank" className="underline">Open health check</a></li>
